...
/*
====================
CL_UpdateGUID: update cl_guid using QKEY_FILE and optional prefix
====================
*/
...
void CL_Connect_f(void)
{
	...
	if (!NET_StringToAdr(clc.servername, &clc.serverAddress)) {
		Com_Printf("Bad server address\n");
...
/*
===============
CL_GenerateQKey: test to see if a valid QKEY_FILE exists.
...
void Com_RandomBytes(unsigned char *string, int len)
{
	int i;
...
void CL_Init( void ) {
	...
	cl_scaleSensWithFov = Cvar_Get("cl_scaleSensWithFov", "1", CVAR_ARCHIVE);
